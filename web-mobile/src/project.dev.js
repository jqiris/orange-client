window.__require = function e(t, n, r) {
  ...
  Alert: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      show: function show(title, content, onok, needcancel) {
        this._alert || (this._alert = cc.find("Canvas/alert"));
  ...
  AnysdkMgr: [ function(require, module, exports) {
    ...
    "use strict";
    cc.sys.isNative && (jsb.reflection.callStaticMethod = function() {});
    cc.Class({
      extends: cc.Component,
      properties: {
        _isCapturing: false
        ...
        var onGetVersion = function onGetVersion(ret) {
          ...
          if (cc.sys.isNative) {
            ...
            cc.loader.load(url, function(err, data) {
              cc.VERSION = data;
              null == ret.version ? console.log("error.") : cc.vv.SI.version != cc.VERSION ? cc.find("Canvas/alert").active = true : cc.director.loadScene(self._mainScene);
            }.bind(this));
          } else cc.director.loadScene(self._mainScene);
        };
        var xhr = null;
        var complete = false;
  ...
  BGScaler: [ function(require, module, exports) {
    "use strict";
    ...
    cc.Class({
      ...
      start: function start() {
        ...
        if (1 == scaleMethod) cvs.fitWidth ? this.node.height = this.node.width / size.width * size.height : this.node.width = this.node.height / size.height * size.width; else if (2 == scaleMethod) if (cvs.fitWidth) {
  ...
  CreateRoom: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      onBtnOK: function onBtnOK() {
        ...
        if (-1 == usedTypes.indexOf(type)) return;
        this.node.active = false;
        this.createRoom();
      },
      ...
      createRoom: function createRoom() {
        ...
        var onCreate = function onCreate(ret) {
          if (0 !== ret.errcode) {
            cc.vv.wc.hide();
            2222 == ret.errcode ? cc.vv.alert.show("\u63d0\u793a", "\u94bb\u77f3\u4e0d\u8db3\uff0c\u521b\u5efa\u623f\u95f4\u5931\u8d25!") : cc.vv.alert.show("\u63d0\u793a", "\u521b\u5efa\u623f\u95f4\u5931\u8d25,\u9519\u8bef\u7801:" + ret.errcode);
          } else cc.vv.gameNetMgr.connectGameServer(ret);
        };
        var type = this.getType();
        var conf = null;
        "xzdd" == type ? conf = this.constructSCMJConf() : "xlch" == type && (conf = this.constructSCMJConf());
        conf.type = type;
        var data = {
      ...
      update: function update(dt) {
        ...
        if (this.lastType != type) {
          this.lastType = type;
          for (var i = 0; i < this._gamelist.childrenCount; ++i) this._gamelist.children[i].active = false;
    ...
    cc.Class({
      ...
      initHandlers: function initHandlers() {
        ...
        cc.vv.net.addHandler("new_user_comes_push", function(data) {
          ...
          needCheckIp && self.dispatchEvent("check_ip", self.seats[seatIndex]);
        });
        ...
        cc.vv.net.addHandler("game_dingque_finish_push", function(data) {
          for (var i = 0; i < data.length; ++i) {
            ...
            i == self.seatIndex && (self.dingque = data[i]);
          }
  ...
  HTTP: [ function(require, module, exports) {
    ...
    function sendRequest(path, data, handler, extraUrl) {
      ...
      xhr.timeout = 5e3;
      null == data && (data = {});
      exports.token && (data.token = exports.token);
      null == extraUrl && (extraUrl = exports.url);
      var sendpath = path;
      var sendtext = "?";
      for (var k in data) {
        "?" != sendtext && (sendtext += "&");
  ...
  ImageLoader: [ function(require, module, exports) {
    ...
    function getBaseInfo(userid, callback) {
      ...
      null != cc.vv.baseInfoMap[userid] ? callback(userid, cc.vv.baseInfoMap[userid]) : cc.vv.http.sendRequest("/base_info", {
        ...
        var url = null;
        ret.headimgurl && (url = cc.vv.http.master_url + "/image?url=" + encodeURIComponent(ret.headimgurl) + ".jpg");
        var info = {
          name: ret.name,
          sex: ret.sex,
          url: url
  ...
  Login: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      start: function start() {
        ...
        if (null != account && null != sign && "" != account && "" != sign) {
          var ret = {
            errcode: 0,
            account: account,
            sign: sign
  ...
  "socket-io": [ function(require, module, exports) {
    (function(global) {
      ...
      (true, cc.sys.isNative) || function(f) {
        if ("object" === ("undefined" === typeof exports ? "undefined" : _typeof(exports)) && "undefined" !== typeof module) module.exports = f(); else if ("function" === typeof define && define.amd) define([], f); else {
          var g;
        ...
        return function e(t, n, r) {
          ...
          3: [ function(_dereq_, module, exports) {
            (function(global) {
              ...
              function Socket(uri, opts) {
                ...
                opts = opts || {};
                if (uri && "object" == ("undefined" === typeof uri ? "undefined" : _typeof(uri))) {
                  opts = uri;
                  uri = null;
                }
                if (uri) {
            ...
            (function(global) {
              ...
              function hasBinary(data) {
                function _hasBinary(obj) {
                  ...
                  } else if (obj && "object" == ("undefined" === typeof obj ? "undefined" : _typeof(obj))) {
          ...
          29: [ function(_dereq_, module, exports) {
            (function(global) {
              (function(root) {
                var freeExports = "object" == ("undefined" === typeof exports ? "undefined" : _typeof(exports)) && exports;
                var freeModule = "object" == ("undefined" === typeof module ? "undefined" : _typeof(module)) && module && module.exports == freeExports && module;
                var freeGlobal = "object" == ("undefined" === typeof global ? "undefined" : _typeof(global)) && global;
          ...
          31: [ function(_dereq_, module, exports) {
            ...
            function lookup(uri, opts) {
              if ("object" == ("undefined" === typeof uri ? "undefined" : _typeof(uri))) {
                opts = uri;
                uri = void 0;
              }
              opts = opts || {};
            ...
            (function(global) {
              ...
              exports.deconstructPacket = function(packet) {
                ...
                function _deconstructPacket(data) {
                  ...
                  if ("object" == ("undefined" === typeof data ? "undefined" : _typeof(data)) && !(data instanceof Date)) {
                    var newData = {};
              ...
              exports.removeBlobs = function(data, callback) {
                function _removeBlobs(obj, curKey, containingObject) {
                  ...
                  } else if (isArray(obj)) for (var i = 0; i < obj.length; i++) _removeBlobs(obj[i], i, obj); else if (obj && "object" == ("undefined" === typeof obj ? "undefined" : _typeof(obj)) && !isBuf(obj)) for (var key in obj) _removeBlobs(obj[key], key, obj);
                }
                var pendingBlobs = 0;
          ...
          50: [ function(_dereq_, module, exports) {
            (function(global) {
              (function() {
                ...
                var freeExports = objectTypes["undefined" === typeof exports ? "undefined" : _typeof(exports)] && exports && !exports.nodeType && exports;
                var root = objectTypes["undefined" === typeof window ? "undefined" : _typeof(window)] && window || this, freeGlobal = freeExports && objectTypes["undefined" === typeof module ? "undefined" : _typeof(module)] && module && !module.nodeType && "object" == ("undefined" === typeof global ? "undefined" : _typeof(global)) && global;
                ...
                function runInContext(context, exports) {
                  ...
                  if ("object" == ("undefined" === typeof nativeJSON ? "undefined" : _typeof(nativeJSON)) && nativeJSON) {
                  ...
                  if (!has("json")) {
                    ...
                    _forEach = function forEach(object, callback) {
                      ...
                      if (size) _forEach = 2 == size ? function forEach(object, callback) {
                        ...
                        _forEach = function forEach(object, callback) {
                          ...
                          var hasProperty = !isFunction && "function" != typeof object.constructor && objectTypes[_typeof(object.hasOwnProperty)] && object.hasOwnProperty || _isProperty;
                    ...
                    if (!has("json-stringify")) {
                      ...
                      var serialize = function serialize(property, object, callback, properties, whitespace, indentation, stack) {
                        ...
                        if ("object" == ("undefined" === typeof value ? "undefined" : _typeof(value)) && value) {
                      ...
                      exports.stringify = function(source, filter, width) {
                        ...
                        if (objectTypes["undefined" === typeof filter ? "undefined" : _typeof(filter)] && filter) if ((className = getClass.call(filter)) == functionClass) callback = filter; else if (className == arrayClass) {
                          properties = {};
                    ...
                    if (!has("json-parse")) {
                      ...
                      var walk = function walk(source, property, callback) {
                        ...
                        if ("object" == ("undefined" === typeof value ? "undefined" : _typeof(value)) && value) if (getClass.call(value) == arrayClass) for (length = value.length; length--; ) update(value, length, callback); else _forEach(value, function(property) {
...
}, {}, [ "socket-io", "AnysdkMgr", "AudioMgr", "BGScaler", "GameNetMgr", "Global", "HTTP", "MahjongMgr", "Net", "ReplayMgr", "UserMgr", "Utils", "VoiceMgr", "Alert", "AppStart", "Chat", "CheckBox", "CreateRole", "CreateRoom", "DingQue", "Folds", "GameOver", "GameResult", "Hall", "History", "HuanSanZhang", "ImageLoader", "JoinGameInput", "LoadingLogic", "Login", "MJGame", "MJRoom", "NoticeTip", "OnBack", "PengGangs", "PopupMgr", "RadioButton", "RadioGroupMgr", "ReConnect", "ReplayCtrl", "Seat", "Settings", "Status", "TimePointer", "UserInfoShow", "Voice", "WaitingConnection" ]);